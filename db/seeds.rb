...
User.create!([
  {name: 'ゲスト', email: 'guest@guest.com', introduction: 'よろしくお願いします！', target_time: 30, password: 'password', confirmed_at: Time.now},
  {name: 'ゲスト2', email: 'guest2@guest.com', introduction: 'よろしくお願いします！', target_time: 30, password: 'password', confirmed_at: Time.now}
  ])
